...
def index():
    ...
    if request.method == 'POST':
        ...
        for row in rows:
            ...
            try:
                marketCap=str('{:,.2f}'.format(round(fast_info['marketCap']/1000000000,2))) + ' B' if fast_info['marketCap']/1000000000>1 else (str('{:,.2f}'.format(round(fast_info['marketCap']/1000000,2))) + ' M') if fast_info['marketCap']/1000000 >1 else str('{:,.2f}'.format(round(fast_info['marketCap']/1000,2))) + ' K'
            except:
                marketCap='---'
